...
{
	class Rifle_Base;
	class mwp1_smg_1_Base: Rifle_Base
	{
		scope = 0;
		weight = 2500;
		absorbency = 0;
	...
	class mwp1_smg_1: mwp1_smg_1_Base
	{
		scope = 2;
		displayName = "MWP1 SMG";
		descriptionShort = "Submachine gun of the first series MWP1-1.// By Meru";
		model = "modern_weapon_pack_1_V2\smg1\mwp1smg1.p3d";
