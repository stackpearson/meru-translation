...
class CfgPatches
{
	class mwp1_sniperrifle_2
	{
		units[] = {"mwp1_sniperrifle_2"};
		weapons[] = {};
		requiredVersion = 0.1;
...
{
	class Rifle_Base;
	class mwp1_sniperrifle_2_Base: Rifle_Base
	{
		scope = 0;
		weight = 3700;
		absorbency = 0;
		...
		magazines[] = {"mwp1_sniperrifle2_magazine"};
