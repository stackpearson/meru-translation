...
{
	class Pistol_Base;
	class mwp1_pistol_2_Base: Pistol_Base
	{
		scope = 0;
		weight = 950;
		absorbency = 0;
		...
		chamberSize = 1;
		chamberedRound = "";
		magazines[] = {"mwp1_pistol2_magazine"};
		...
		{
			soundSetShot[] = {"mwp1_pistol2_shoot_SoundSet","mwp1_rifle_1_tail_SoundSet","mwp1_rifle_1_tail_SoundSet"};
	...
	class mwp1_pistol_2: mwp1_pistol_2_Base
	{
		scope = 2;
		displayName = "Пистолет MWP-2";
		descriptionShort = "Модернизированный пистолет MWP1 Второй серии.// By Meru";
		model = "modern_weapon_pack_1_V2\pistol2\mwp1pistol2.p3d";
