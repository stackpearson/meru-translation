...
class CfgPatches
{
	class mwp1_shotgun_3
	{
		units[] = {"mwp1_shotgun_3"};
		weapons[] = {};
		requiredVersion = 0.1;
...
{
	class Rifle_Base;
	class mwp1_shotgun_3_Base: Rifle_Base
	{
		scope = 0;
		weight = 3600;
		absorbency = 0;
		...
		magazines[] = {"mwp1_shotgun3_magazine"};
	...
	class mwp1_shotgun_3: mwp1_shotgun_3_Base
	{
		scope = 2;
		displayName = "MWP1-3 Shotgun";
		descriptionShort = "Automatic shotgun MWP1-3. Accepts detachable mags. //By Meru";
		model = "modern_weapon_pack_1_V2\shotgun3\mwp1shotgun3.p3d";
