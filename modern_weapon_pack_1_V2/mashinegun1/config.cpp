...
class CfgPatches
{
	class mwp1_mashinegun_1
	{
		units[] = {"mwp1_mashinegun_1"};
		weapons[] = {};
		requiredVersion = 0.1;
...
{
	class Rifle_Base;
	class mwp1_mashinegun_1_Base: Rifle_Base
	{
		scope = 0;
		weight = 3700;
		absorbency = 0;
		...
		chamberSize = 1;
		chamberedRound = "";
		chamberableFrom[] = {"Ammo_mwp1pulemet"};
		magazines[] = {"mwp1_mashinegun1_magazine"};
		...
		{
			soundSetShot[] = {"mwp1_mashinegune1_shoot_SoundSet","mwp1_rifle_1_tail_SoundSet","mwp1_rifle_1_tail_SoundSet"};
	...
	class mwp1_mashinegun_1: mwp1_mashinegun_1_Base
	{
		scope = 2;
		displayName = "MWP1 Machinegun";
		descriptionShort = "Upgraded Machine Gun of the first series MWP1.//By Meru";
		model = "modern_weapon_pack_1_V2\mashinegun1\mwp1_mashinegun1.p3d";
