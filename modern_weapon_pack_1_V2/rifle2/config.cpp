...
{
	class Rifle_Base;
	class mwp1_rifle_2_Base: Rifle_Base
	{
		scope = 0;
		weight = 3700;
		absorbency = 0;
		...
		magazines[] = {"mwp1_rifle2_magazine"};
		...
		{
			soundSetShot[] = {"mwp1_rifle_2_shoot_SoundSet","mwp1_rifle_1_tail_SoundSet","mwp1_rifle_1_tail_SoundSet"};
	...
	class mwp1_rifle_2: mwp1_rifle_2_Base
	{
		scope = 2;
		displayName = "Автомат MWP1-2";
		descriptionShort = "Модернизированный автомат второй серии MWP1.//By Meru";
		model = "modern_weapon_pack_1_V2\rifle2\mwp1rifle2.p3d";
