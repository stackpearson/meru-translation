...
{
	class Pistol_Base;
	class mwp1_pistol_1_Base: Pistol_Base
	{
		scope = 0;
		weight = 950;
		absorbency = 0;
		...
		chamberSize = 1;
		chamberedRound = "";
		magazines[] = {"mwp1_pistol1_magazine"};
		...
		{
			soundSetShot[] = {"mwp1_pistol1_shoot_SoundSet","mwp1_rifle_1_tail_SoundSet","mwp1_rifle_1_tail_SoundSet"};
	...
	class mwp1_pistol_1: mwp1_pistol_1_Base
	{
		scope = 2;
		displayName = "Пистолет MWP-1";
		descriptionShort = "Модернизированный пистолет MWP1 Первой серии.// By Meru";
		model = "modern_weapon_pack_1_V2\pistol1\mwp1pistol1.p3d";
