...
{
	class Rifle_Base;
	class mwp1_minigun_1_Base: Rifle_Base
	{
		scope = 0;
		attachments[] = {"MiniganBarrels"};
		itemSize[] = {10,5};
		weight = 28;
		absorbency = 0;
		...
		magazines[] = {"mwp1_minigun_1_magazine"};
...
class cfgVehicles
{
	...
	class SE_Min_Barrels: Inventory_Base
	{
		scope = 2;
		model = "modern_weapon_pack_1_V2\minigun1\mwp1_minigun1_barrels.p3d";
		weight = 1;
		inventorySlot[] = {"MiniganBarrels"};
		class DamageSystem
		{
			class GlobalHealth
			{
...
class CfgNonAIVehicles
{
	...
	class Proxymwp1_minigun1_barrels: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "MiniganBarrels";
		model = "modern_weapon_pack_1_V2\minigun1\mwp1_minigun1_barrels.p3d";
