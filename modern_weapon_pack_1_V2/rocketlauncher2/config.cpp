////////////////////////////////////////////////////////////////////
//DeRap: rocketlauncher2\config.bin
...
class CfgPatches
{
	class mwp1_rocketlauncher_2
	{
		units[] = {"mwp1_rocketlauncher_2"};
		weapons[] = {};
		requiredVersion = 0.1;
...
{
	class Pistol_Base;
	class mwp1_rocketlauncher_2_Base: Pistol_Base
	{
		scope = 0;
		weight = 950;
		absorbency = 0;
		...
		chamberSize = 1;
		chamberedRound = "";
		magazines[] = {"mwp1_rocketlauncherlauncher_magazine"};
		chamberableFrom[] = {"Ammo_RocketMWP1_2"};
		ejectType = 1;
