...
class CfgPatches
{
	class mwp1_mashinegun_2
	{
		units[] = {"mwp1_mashinegun_2"};
		weapons[] = {};
		requiredVersion = 0.1;
...
{
	class Rifle_Base;
	class mwp1_mashinegun_2_Base: Rifle_Base
	{
		scope = 0;
		weight = 3700;
		absorbency = 0;
		...
		magazines[] = {"mwp1_mashinegun2_magazine"};
		...
		{
			soundSetShot[] = {"mwp1_mashinegune2_shoot_SoundSet","mwp1_rifle_1_tail_SoundSet","mwp1_rifle_1_tail_SoundSet"};
