...
{
	class Rifle_Base;
	class mwp1_rifle_1_Base: Rifle_Base
	{
		scope = 0;
		weight = 3700;
		absorbency = 0;
		...
		magazines[] = {"mwp1_rifle1_magazine"};
		...
		{
			soundSetShot[] = {"mwp1_rifle_1_shoot_SoundSet","mwp1_rifle_1_tail_SoundSet","mwp1_rifle_1_tail_SoundSet"};
	...
	class mwp1_rifle_1: mwp1_rifle_1_Base
	{
		scope = 2;
		displayName = "Автомат MWP1-1";
		descriptionShort = "Модернизированный автомат первой серии MWP1.//By Meru";
		model = "modern_weapon_pack_1_V2\rifle1\mwp1_rifle_1.p3d";
